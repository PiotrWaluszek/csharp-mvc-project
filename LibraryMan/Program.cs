...
builder.Services.AddDbContext<LibraryMan.Data.LibraryManContext>(options =>
    options.UseSqlite(builder.Configuration.GetConnectionString("LibraryManContext") ?? throw new InvalidOperationException("Connection string 'LibraryMan.Data.LibraryManContext' not found.")));
...
LibraryMan.Commons.Database.CreateDatabase();
