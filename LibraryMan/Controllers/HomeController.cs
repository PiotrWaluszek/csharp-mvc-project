...
public class HomeController : Controller
{
    ...
    private readonly string DatabaseName = "./LibraryMan.Data.db";
    ...
    public IActionResult Login(UzytkownikModel model)
    {
        ...
        if (verifiedUser != null)
        {
            ...
            return RedirectToAction("Katalog", "Ksiazka", model);
        }
        else
        {
    ...
    public UzytkownikModel ? LoginVerify(SqliteConnection connection, string email, string password)
    {
        ...
        command.Parameters.AddWithValue("@Haslo", LibraryMan.Commons.Hash.CalculateMD5Hash(password));
        ...
        if (reader.Read())
        {
            return new UzytkownikModel
            {
                ...
                Password = LibraryMan.Commons.Hash.CalculateMD5Hash(password),
